...
echo"<td  rowspan=2 class=\"links\" ><a href=\"index.php\">sign out</a><br><a href=\"list.php\">list clients</a><br><a href=\"changepassword.php\">change pw</a>";
if ($vincentian[2]=="a") 
...
$endM= 12;
$startY= 2011;
$end=$startY*372+$endM*31+$endD;
$startD= 1;
$startM= 1;


$start=$startY*372+$startM*31+$startD;
...
while(!feof($f))
{
	...
	while(trim($list[$c]) != "end")
	{
		...
		{
			$adults+=$tempadults;
			$preschool+=$temppreschool;
			$gradeschool+=$tempgradeschool;
			$teen+=$tempteen;
			$famtot++;
			if ($fam<2) $family[1]++;
