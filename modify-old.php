...
if ($selection==-1) $selection=10000;
...
// this function inputs $x = date in the form m/d/y
// returns input selection display for date
// if the date entered is valid, it will become the default date
// $y distinquishes multiple input dates
...
// input date in the form  m/d/y
// output text format: "mmm d, yyyy"
function mydate($x)
